...
/* Activity class which defines ninth quiz question and saves score in shared preferences */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                correctAnswer = "more than 3 million";
                ...
                if (radioChoice == -1) {
                    ...
                    if (rbSelected.equals(correctAnswer)){
                        ...
                        Intent intent = new Intent(QuestionNine.this, GameLost.class);
                        startActivity(intent);
                        finish();
                    }
                }
